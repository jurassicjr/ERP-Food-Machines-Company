...
public class InventoryFrame extends JFrame {
	...
	public void initializePrincipal() {
		...
		JComboBox<CNPJ> cboCNPJ = new JComboBox<CNPJ>();
				...
				.addGroup(gl_principalPanel.createSequentialGroup()
					...
					.addGroup(gl_principalPanel.createParallelGroup(Alignment.TRAILING, false)
						...
						.addGroup(Alignment.LEADING, gl_principalPanel.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(cboCNPJ, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addGroup(Alignment.LEADING, gl_principalPanel.createSequentialGroup()
						...
						.addGroup(Alignment.LEADING, gl_principalPanel.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(cboSupplier, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))

...
import util.Icon;
import financial.controller.GenerateFinancialReportFrameController;

public class GenerateFinancialReportFrame extends JFrame {
	...
	private GenerateFinancialReportFrameController controller;

	public GenerateFinancialReportFrame() {
		
		controller = new GenerateFinancialReportFrameController(this);
	...
	private void initialize() {
		...
		btnCancel.setIcon(new ImageIcon(GenerateFinancialReportFrame.class.getResource("/resources/cancel.png")));
		panel.add(btnCancel);
		
		btnGenerate = new JButton("Criar Relatório");
		btnGenerate.setIcon(new ImageIcon(GenerateFinancialReportFrame.class.getResource("/resources/ok.png")));
		...
		btnSelectFile.setIcon(new ImageIcon(GenerateFinancialReportFrame.class.getResource("/resources/open.png")));

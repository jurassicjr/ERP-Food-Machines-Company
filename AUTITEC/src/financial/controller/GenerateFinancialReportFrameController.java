...
public class GenerateFinancialReportFrameController {
	...
	private GenerateFinancialReportFrame frame;
	
	private DataBase dataBase = new DataBase();
	
	public GenerateFinancialReportFrameController(GenerateFinancialReportFrame frame) {

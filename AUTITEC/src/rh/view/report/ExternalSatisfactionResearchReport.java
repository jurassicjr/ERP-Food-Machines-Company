...
import rh.controller.ExternalSatisfactionResearchReportController;
import userInterface.components.FileChooser;
import util.ClearFrame;
import util.ShowMessage;

public class ExternalSatisfactionResearchReport extends JFrame{
	
	/**
	 * 
	 */
    private static final long serialVersionUID = 1024784797028586801L;
	...
	private ExternalSatisfactionResearchReportController controller;
	private FileChooser fileChooser;
	private JLabel lblReportArchive;

	public ExternalSatisfactionResearchReport() {
		initialize();
		setListeners();
		controller = new ExternalSatisfactionResearchReportController(this);
		fileChooser = new FileChooser();
	}

	private void initialize() {
		setTitle("Relatório de Pesquisa de Satisfação Externa");

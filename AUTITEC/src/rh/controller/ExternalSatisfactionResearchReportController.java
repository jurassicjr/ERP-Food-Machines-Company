...
public class ExternalSatisfactionResearchReportController {
	
	private JFrame frame;
	private DataBase dataBase;

	public ExternalSatisfactionResearchReportController(JFrame frame) {
		this.frame = frame;
	...
	public void generateReport(String reportPathFile, boolean openFile, Map<String, Object> map)
		...
		java.io.InputStream jasperIS = getClass().getResourceAsStream("/resources/filesReportsTemplate/External_Satisfaction_Research.jasper");
